                ...
                <div class="mdk-drawer-layout__content page">
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                            ...
                            <a href="create-homework.php" class="btn btn-primary">اضافة واجب منزلي</a>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                            <?php  
                                              $query = mysqli_query($conn,"SELECT * FROM homeworks WHERE teacher_id = $user_id");
                                              $no = 1;
                                              ...
                                              <tr>
                                                ...
                                                <td><a class="btn btn-primary" href="veiw-homework.php?id=<?= $results['id'] ?>">عرض</a></td>
                                              </tr>
                                              <?php $no++; } ?>
                                            </tbody>
                                        </table>
