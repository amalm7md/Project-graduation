                        ...
                        <div class="d-flex sidebar-account flex-shrink-0 mr-auto mr-lg-0">
                            <a href="index.html" class="flex d-flex align-items-center text-underline-0">
                                <span class="flex d-flex flex-column text-white">
                                    <strong class="sidebar-brand">البوابة الاكاديمية</strong>
                                </span>
                            </a>
                        </div>
                                ...
                                <div id="notifications_menu" class="dropdown-menu dropdown-menu-right navbar-notifications-menu">
                                    ...
                                    <div class="navbar-notifications-menu__content" style="position:relative" data-perfect-scrollbar>
                                        <div class="dropdown-item d-flex py-2">
                                            ...
                                            <div class="">
                                                <a href="">مثال على اشعار<br>
                                                <small class="text-muted">منذ 1 دقيقة</small>
                                            </div>
                                        </div>
                                        <div class="dropdown-item d-flex py-2">
                                            <div class="mr-3">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item text-center navbar-notifications-menu__footer">عرض الكل</a>
                                    </div>
                                </div>
                            </li>
                            <li class="nav-item">
                            ...
                            <div id="company_menu" class="dropdown-menu dropdown-menu-right navbar-company-menu">
                                <div class="dropdown-item d-flex align-items-center py-2 navbar-company-info py-3">
                                    ...
                                    <span class="flex d-flex flex-column">
                                        ...
                                        <small class="text-muted text-uppercase">مدرس</small>
                                    </span>
                                </div>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item d-flex align-items-center py-2" href="profile.php">
                                    <span class="material-icons mr-2">account_circle</span> البروفايل
                                </a>
                        ...
                        <div class="sidebar sidebar-light sidebar-left bg-white" data-perfect-scrollbar>
                            <div class="sidebar-block p-0">
                                ...
                                <ul class="sidebar-menu mt-0">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="subjects.html">
                                            <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                                    <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="classes.html">
                                            <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                                    <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="students.html">
                                            <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                                    <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="quizes.html">
                                            <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                                    <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="homeworks.html">
                                            <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                                    <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="notifications.html">
                                            <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                                    <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="events.html">
                                            <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                                    <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
        ...
        <div class="mdk-drawer__content">
            <div class="sidebar sidebar-light sidebar-left" data-perfect-scrollbar>
                <small class="text-dark-gray px-3 py-1">
                    <strong>الخميس, 28/4/1010</strong>
                </small>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="d-flex flex-column flex">
                                    <a href="#" class="text-body"><strong class="text-15pt">مثال على حدث</strong></a>
                                    <small class="text-muted d-flex align-items-center">المصدر</small>
                                </div>
                            </div>
                        </div>
                    </div>
