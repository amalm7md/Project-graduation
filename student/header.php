...
include '../inc/db.php'; 
$user_id = $_SESSION['id'];
$user = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM students WHERE user_id=$user_id"));
                        ...
                        <ul class="nav navbar-nav d-none d-md-flex ml-auto">
                            <li class="nav-item dropdown">
                                ...
                                <div id="notifications_menu" class="dropdown-menu dropdown-menu-right navbar-notifications-menu">
                                    ...
                                    <?php  
                                    $query = mysqli_query($conn,"SELECT * FROM notifications WHERE usertype = 2 OR (usertype = 3 AND class = $user_class) LIMIT 5");
                                    $no = 1;
                            ...
                            <div id="company_menu" class="dropdown-menu dropdown-menu-right navbar-company-menu">
                                <div class="dropdown-item d-flex align-items-center py-2 navbar-company-info py-3">
                                    ...
                                    <span class="flex d-flex flex-column">
                                        <strong class="h5 m-0">الطالب</strong>
                                    </span>
                                </div>
